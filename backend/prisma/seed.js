...
async function main() {
  ...
  const categories = [
    ...
    { id: 'cat-icse', name: 'ICSE', slug: 'icse', icon: '📖' },
    { id: 'cat-up-board', name: 'UP Board', slug: 'up-board', icon: '🏫' },
  ...
  await prisma.course.upsert({
    where: { id: 'course-cbse-science-12' },
    update: {
      examTrack: 'CBSE',
      classLevel: 'Class 12',
      medium: 'Hinglish',
    ...
    create: {
      id: 'course-cbse-science-12',
      title: 'CBSE Class 12 Science Batch',
      subtitle: 'Physics, Chemistry, Maths & Biology | Live + recorded',
      description: 'Complete CBSE Class 12 Science preparation with live classes, DPP, and board-style mock tests.',
      thumbnail: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=800',
      price: 1999,
      originalPrice: 5999,
      level: 'INTERMEDIATE',
      language: 'Hinglish',
      learningObjectives: ['Board exam readiness', 'NCERT + exemplar coverage', 'Weekly science mocks'],
      requirements: ['Class 12 CBSE students'],
      targetAudience: ['CBSE Science students'],
      isPublished: true,
      teacherId: teacher.id,
      categoryId: 'cat-cbse',
      examTrack: 'CBSE',
  ...
  await prisma.course.upsert({
    ...
    create: {
      id: 'course-icse-10',
      title: 'ICSE Class 10 Complete Batch',
      subtitle: 'All subjects | Live doubt solving | Board pattern tests',
      description: 'Structured ICSE Class 10 batch covering syllabus with live classes and revision marathons.',
      thumbnail: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800',
      price: 1499,
      originalPrice: 4499,
      level: 'INTERMEDIATE',
      language: 'English',
      learningObjectives: ['ICSE board syllabus', 'Sample paper practice', 'Doubt sessions'],
      requirements: ['Class 10 ICSE students'],
      targetAudience: ['ICSE board aspirants'],
      isPublished: true,
      teacherId: teacher.id,
      categoryId: 'cat-icse',
      examTrack: 'ICSE',
  ...
  await prisma.course.upsert({
    ...
    create: {
      id: 'course-up-board-12',
      title: 'UP Board Class 12 Science Batch',
      subtitle: 'UPMSP syllabus | Hindi medium | Live classes',
      description: 'UP Board Class 12 Science batch with live teaching, notes, and UPMSP pattern mock tests.',
      thumbnail: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=800',
      price: 999,
      originalPrice: 3499,
      level: 'INTERMEDIATE',
      language: 'Hindi',
      learningObjectives: ['UPMSP syllabus coverage', 'Previous year papers', 'Live revision'],
      requirements: ['Class 12 UP Board students'],
      targetAudience: ['UP Board science students'],
      isPublished: true,
      teacherId: teacher.id,
      categoryId: 'cat-up-board',
      examTrack: 'UP Board',
      classLevel: 'Class 12',
      targetExamYear: '2026',
      medium: 'Hindi',
